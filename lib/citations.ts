...
export const citationCategories: CitationCategory[] = [
  {
    ...
    directories: [
      ...
      { name: "Justdial", url: "https://www.justdial.com", type: "local", freeOrPaid: "freemium", importance: "critical", description: "India's largest local business directory. High authority for Indian business citations." },
      { name: "Sulekha", url: "https://www.sulekha.com", type: "local", freeOrPaid: "freemium", importance: "important", description: "Major Indian services marketplace. Strong local citation signal." },
      { name: "IndiaMART", url: "https://www.indiamart.com", type: "local", freeOrPaid: "freemium", importance: "important", description: "India's largest B2B marketplace. Important for service businesses." },
      { name: "TradeIndia", url: "https://www.tradeindia.com", type: "local", freeOrPaid: "freemium", importance: "nice-to-have", description: "B2B directory for Indian businesses. Additional citation source." },
      { name: "YellowPages India", url: "https://www.yellowpages.co.in", type: "local", freeOrPaid: "free", importance: "nice-to-have", description: "Classic directory listing. Adds to NAP consistency." },
  ...
  },
  {
    ...
    directories: [
      { name: "Practo", url: "https://www.practo.com", type: "healthcare", freeOrPaid: "freemium", importance: "critical", description: "India's #1 healthcare platform. AI systems heavily cite Practo listings and reviews." },
      { name: "Lybrate", url: "https://www.lybrate.com", type: "healthcare", freeOrPaid: "freemium", importance: "critical", description: "Major health Q&A and doctor listing platform. Strong AI citation source." },
      ...
      { name: "1mg", url: "https://www.1mg.com", type: "healthcare", freeOrPaid: "free", importance: "important", description: "Health platform with doctor consultation listings." },
  ...
  },
  {
    ...
    directories: [
      { name: "LegalKart", url: "https://www.legalkart.com", type: "legal", freeOrPaid: "freemium", importance: "critical", description: "India's legal services marketplace. Key citation for lawyer AI visibility." },
      { name: "Vakil Search", url: "https://vakilsearch.com", type: "legal", freeOrPaid: "freemium", importance: "critical", description: "Popular legal services platform. Strong authority signal." },
      ...
      { name: "LawRato", url: "https://lawrato.com", type: "legal", freeOrPaid: "free", importance: "important", description: "Free legal advice and lawyer directory." },
      ...
      { name: "Bar Council Directory", url: "https://www.barcouncilofindia.org", type: "legal", freeOrPaid: "free", importance: "important", description: "Official bar council listing. Highest authority for legal credentials." },
    ],
  },
  {
    slug: "real-estate",
    ...
    directories: [
      { name: "99acres", url: "https://www.99acres.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "India's largest property portal. Major AI citation source for real estate." },
      { name: "MagicBricks", url: "https://www.magicbricks.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "Top property platform. AI frequently cites MagicBricks data." },
      { name: "Housing.com", url: "https://housing.com", type: "lifestyle", freeOrPaid: "freemium", importance: "important", description: "Property search platform with builder profiles." },
      { name: "NoBroker", url: "https://www.nobroker.in", type: "lifestyle", freeOrPaid: "freemium", importance: "important", description: "Direct owner-to-buyer platform. Growing citation authority." },
  ...
  },
  {
    ...
    directories: [
      { name: "Shiksha", url: "https://www.shiksha.com", type: "education", freeOrPaid: "freemium", importance: "critical", description: "India's largest education portal. AI heavily cites Shiksha for coaching and college recommendations." },
      { name: "Careers360", url: "https://www.careers360.com", type: "education", freeOrPaid: "freemium", importance: "critical", description: "Education and career platform with institute rankings." },
      { name: "CollegeDunia", url: "https://collegedunia.com", type: "education", freeOrPaid: "freemium", importance: "important", description: "College and coaching comparison platform." },
  ...
  },
  {
    ...
    directories: [
      { name: "ICAI Directory", url: "https://www.icai.org", type: "finance", freeOrPaid: "free", importance: "critical", description: "Official CA directory from ICAI. Highest authority for chartered accountant credentials." },
      { name: "CAclubindia", url: "https://www.caclubindia.com", type: "finance", freeOrPaid: "free", importance: "critical", description: "India's largest CA community. Strong citation authority for accounting firms." },
      ...
      { name: "ClearTax", url: "https://cleartax.in", type: "finance", freeOrPaid: "freemium", importance: "important", description: "Tax filing platform with CA directory." },
      { name: "Zoho Books Directory", url: "https://www.zoho.com/books/accountants", type: "finance", freeOrPaid: "free", importance: "nice-to-have", description: "Accounting partner directory." },
    ],
  },
  {
    ...
    directories: [
      { name: "Zomato", url: "https://www.zomato.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "India's #1 food platform. Critical for restaurant AI visibility." },
      ...
      { name: "WedMeGood", url: "https://www.wedmegood.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "India's top wedding platform. Critical for wedding planners, photographers, venues." },
      ...
      { name: "Houzz India", url: "https://www.houzz.in", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "Interior design platform. Key citation for interior designers." },
