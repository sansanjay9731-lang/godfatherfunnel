...
export const citationCategories: CitationCategory[] = [
  {
    ...
    directories: [
      ...
      { name: "Yelp", url: "https://www.justdial.com", type: "local", freeOrPaid: "freemium", importance: "critical", description: "Global's largest local business directory. High authority for Global business citations." },
      { name: "Bing Places", url: "https://www.sulekha.com", type: "local", freeOrPaid: "freemium", importance: "important", description: "Major Global services marketplace. Strong local citation signal." },
      { name: "IndiaMART", url: "https://www.indiamart.com", type: "local", freeOrPaid: "freemium", importance: "important", description: "Global's largest B2B marketplace. Important for service businesses." },
      { name: "TradeIndia", url: "https://www.tradeindia.com", type: "local", freeOrPaid: "freemium", importance: "nice-to-have", description: "B2B directory for Global businesses. Additional citation source." },
      { name: "YellowPages Global", url: "https://www.yellowpages.co.in", type: "local", freeOrPaid: "free", importance: "nice-to-have", description: "Classic directory listing. Adds to NAP consistency." },
  ...
  },
  {
    ...
    directories: [
      { name: "Zocdoc", url: "https://www.practo.com", type: "healthcare", freeOrPaid: "freemium", importance: "critical", description: "#1 healthcare platform. AI systems heavily cite Zocdoc listings and reviews." },
      { name: "Healthgrades", url: "https://www.lybrate.com", type: "healthcare", freeOrPaid: "freemium", importance: "critical", description: "Major health Q&A and doctor listing platform. Strong AI citation source." },
  ...
  },
  {
    ...
    directories: [
      { name: "FindLaw", url: "https://www.legalkart.com", type: "legal", freeOrPaid: "freemium", importance: "critical", description: "Global's legal services marketplace. Key citation for lawyer AI visibility." },
  ...
  },
  {
    ...
    directories: [
      { name: "99acres", url: "https://www.99acres.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "Global's largest property portal. Major AI citation source for real estate." },
  ...
  },
  {
    ...
    directories: [
      { name: "Shiksha", url: "https://www.shiksha.com", type: "education", freeOrPaid: "freemium", importance: "critical", description: "Global's largest education portal. AI heavily cites Shiksha for coaching and college recommendations." },
  ...
  },
  {
    ...
    directories: [
      ...
      { name: "CAclubindia", url: "https://www.caclubindia.com", type: "finance", freeOrPaid: "free", importance: "critical", description: "Global's largest CA community. Strong citation authority for accounting firms." },
  ...
  },
  {
    ...
    directories: [
      ...
      { name: "WedMeGood", url: "https://www.wedmegood.com", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "Global's top wedding platform. Critical for wedding planners, photographers, venues." },
      ...
      { name: "Houzz Global", url: "https://www.houzz.in", type: "lifestyle", freeOrPaid: "freemium", importance: "critical", description: "Interior design platform. Key citation for interior designers." },
