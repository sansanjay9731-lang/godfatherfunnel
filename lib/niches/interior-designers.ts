...
export const nicheData: NicheData = {
  ...
  heroSubline:
    "When someone budgets ₹5-25L for a home interior, the first thing they do is ask ChatGPT or Google AI for recommendations. If your portfolio and expertise aren't visible to AI, that project goes to a competitor.",
  painPoints: [
    {
      title: "₹5-25L Projects Going to AI-Recommended Designers",
      description:
        "Homeowners ask AI 'best interior designer in Bangalore' or 'modular kitchen cost'. AI recommends 3-5 designers. If you're not on that list, someone else designs that dream home — and earns that ₹10-25L fee.",
    },
    {
  ...
  faqItems: [
    {
      ...
      answer:
        "Homeowners ask ChatGPT and Google AI questions like 'best interior designer in Pune under ₹15L', 'modular kitchen cost in India', or 'modern vs contemporary interior design'. AI provides direct recommendations with reasons, bypassing traditional search.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes. AI recommendations include context about your specialization and price range. Properly optimized profiles attract clients who match your ideal project size, whether that's ₹5L apartments or ₹50L villas.",
    },
    {
  ...
  stats: [
    ...
    { label: "Average Home Interior Project Value", value: "₹8-15L" },
  ...
  searchExample: "best interior designer in Bangalore",
  ...
  treatments: [
    {
      ...
      faqItems: [
        {
          question: "What is the average home interior design cost in India?",
          answer:
            "Home interior design costs range from ₹5,00,000 to ₹25,00,000 for a 2-3 BHK apartment. This includes modular furniture, false ceiling, electrical work, painting, and designer fees. Luxury interiors can exceed ₹40L.",
        },
        {
          question: "How is interior design cost calculated?",
          answer:
            "Interior design cost is calculated per square foot (₹1,500-4,000/sqft) or as a project fee. It includes design consultation (₹50K-2L), material cost (60-70% of total), and labor charges (15-20% of total).",
        },
        {
          question: "Can I do home interiors in phases to reduce cost?",
          answer:
            "Yes, many designers offer phased execution — starting with kitchen and living room (₹3-5L), then bedrooms (₹2-4L each). This spreads the cost over 6-12 months without compromising design cohesion.",
        },
      ],
    },
    {
      ...
      description:
        "Modular kitchen is the #1 searched interior design query in India. Every homeowner wants to know the cost, materials, and best designers for their kitchen renovation.",
      faqItems: [
        {
          question: "What is the average modular kitchen cost in India?",
          answer:
            "A modular kitchen costs ₹1,50,000 to ₹8,00,000 depending on size, material, and finish. L-shaped kitchens start at ₹1.5L, U-shaped at ₹2.5L, and island kitchens at ₹4L+. Material choice (plywood, MDF, acrylic) significantly affects pricing.",
        },
        {
          question: "Which material is best for modular kitchen in India?",
          answer:
            "Marine plywood with laminate finish offers the best balance of durability and cost (₹1.5-3L). For premium kitchens, acrylic or PU finish on BWR plywood (₹3-6L) is recommended. Avoid particle board in humid Indian kitchens.",
        },
      ],
    },
    {
      ...
      faqItems: [
        {
          ...
          answer:
            "Office interior costs range from ₹1,000 to ₹3,500 per square foot. Basic fit-outs start at ₹1,000/sqft, mid-range at ₹1,500-2,500/sqft, and premium corporate offices at ₹2,500-3,500/sqft. A 1,000 sqft office typically costs ₹10-25L.",
        },
        {
      ...
      faqItems: [
        {
          ...
          answer:
            "Bedroom interior design costs ₹1,00,000 to ₹5,00,000. This includes a sliding wardrobe (₹40K-1.5L), bed with storage (₹30K-80K), false ceiling (₹20K-50K), and lighting (₹10K-30K). Master bedrooms cost 30-50% more than standard bedrooms.",
        },
        {
          question: "What are the trending bedroom design styles in India?",
          answer:
            "Minimalist Japandi, warm contemporary, and luxury modern are trending. Neutral palettes with accent walls, integrated wardrobe systems, and smart lighting are most requested. Budget for trends: ₹1.5-3L per bedroom.",
        },
      ],
    },
    {
      ...
      faqItems: [
        {
          ...
          answer:
            "Living room interior design costs ₹1,50,000 to ₹6,00,000. This includes TV unit (₹30K-1L), sofa set (₹40K-2L), false ceiling with lighting (₹30K-80K), accent wall (₹20K-60K), and flooring upgrade (₹50K-1.5L).",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Most Indian 2-3 BHK apartments have 150-250 sqft living rooms. Optimal furniture layout for this size includes an L-shaped sofa, a TV unit, and a small dining extension. Interior designers charge ₹1-3L for this space.",
        },
      ],
    },
    {
      ...
      faqItems: [
        {
          question: "What is the average bathroom renovation cost in India?",
          answer:
            "Bathroom renovation costs ₹75,000 to ₹3,00,000. Basic renovation (tiles + fixtures) starts at ₹75K. Mid-range with branded fittings costs ₹1.5-2L. Premium renovation with imported tiles and smart fixtures costs ₹2-3L+.",
        },
        {
