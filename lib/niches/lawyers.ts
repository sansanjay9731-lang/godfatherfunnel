...
export const nicheData: NicheData = {
  ...
  heroSubline:
    "When someone asks ChatGPT 'best lawyer for property disputes near me,' AI names specific firms. If your practice isn't optimized for AI, you're invisible to clients willing to pay ₹25K-5L in retainer fees.",
  searchExample: "best property lawyer in Pune",
  competitorLine:
  ...
  painPoints: [
    {
      ...
      description:
        "Corporate clients paying ₹25K-5L retainers now use AI to shortlist law firms. Individuals seeking divorce lawyers, property attorneys, or criminal defence ask AI before asking friends. If AI doesn't recommend you, you're not on their shortlist.",
    },
    {
  ...
  roiExample: {
    ...
    pitch:
      "A single corporate retainer client pays ₹25K-5L per engagement, with recurring matters worth ₹5-20L annually. Property dispute cases generate ₹50K-2L per matter. Our AEO investment pays for itself with just ONE new client per quarter.",
  },
  faqItems: [
    {
    ...
    },
    {
      ...
      answer:
        "Absolutely. Corporate legal officers and startup founders increasingly use AI to identify law firms for specific matters. We optimize your practice for queries like 'best corporate lawyer for startup funding in [city]' and 'IP lawyer for patent filing in India,' targeting high-value corporate work.",
    },
    {
  ...
  treatments: [
    {
      ...
      description:
        "Corporate legal services are the highest-value practice area in India. Businesses search AI for lawyers specializing in company formation, mergers, contracts, and compliance. Fee structures include monthly retainers, project-based fees, and hourly billing.",
      faqItems: [
        {
          question: "How much does a corporate lawyer charge in India?",
          answer:
            "Fees vary widely: solo practitioners charge ₹25K-1L per matter, mid-size firms charge ₹1-3L monthly retainers, and top-tier firms charge ₹3-5L+ monthly. Specific matters like M&A transactions can cost ₹5-50L depending on deal size. Startup-friendly lawyers may offer packages at ₹50K-1.5L for incorporation and initial compliance.",
        },
        {
          question: "When should a startup hire a corporate lawyer?",
          answer:
            "Hire a corporate lawyer before incorporation to structure the entity correctly (LLP vs. Pvt Ltd). Critical milestones requiring legal help: co-founder agreement, first employee hires (employment contracts), fundraising (term sheet review), and IP protection. Budget ₹50K-1.5L for the first year of legal support.",
        },
        {
    ...
    },
    {
      ...
      description:
        "Property disputes and real estate transactions are among the most common legal matters in India. Clients frequently ask AI about title verification, property registration, and dispute resolution costs. Property lawyers handle title searches, sale deed drafting, RERA compliance, and encumbrance certificates.",
      faqItems: [
        {
          question: "How much does a property lawyer charge for title verification?",
          answer:
            "Basic title verification costs ₹10K-25K depending on property complexity and city. This includes reviewing the chain of title for 30 years, checking encumbrance certificates, verifying land revenue records, and confirming no litigation pending. For large properties or land parcels, comprehensive due diligence may cost ₹25K-1L.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Property disputes in Indian civil courts typically take 3-10 years. Revenue court disputes (mutation, partition) take 1-3 years. Mediation and out-of-court settlement can resolve matters in 3-6 months. RERA complaints for builder disputes are resolved within 60 days in theory, but practically take 6-12 months.",
        },
      ],
    },
    {
      ...
      faqItems: [
        {
          ...
          answer:
            "Regular bail in a sessions court costs ₹10K-50K in legal fees. Anticipatory bail applications cost ₹25K-1L. High court bail for serious offences costs ₹50K-3L. Supreme Court bail can cost ₹1-5L or more. Additional costs include court fees, filing charges, and surety bond assistance. Retain a criminal lawyer before you need one urgently.",
        },
        {
    ...
    },
    {
      ...
      description:
        "Intellectual property law is a growing practice area in India with increasing demand from startups, creators, and businesses. AI assistants frequently explain trademark, patent, and copyright processes to potential clients. IP lawyers handle registrations, enforcement, and licensing agreements.",
      faqItems: [
        {
          question: "How much does it cost to file a trademark in India?",
          answer:
        ...
        {
          question: "How much does a patent lawyer charge in India?",
          answer:
            "Patent drafting and filing costs ₹50K-2L for a standard patent application (government fee ₹1,600-8,000 depending on entity type). Complete patent prosecution through grant costs ₹1-3L over 3-5 years. Provisional patent applications are cheaper (₹30K-80K) and buy 12 months of protection while you develop your invention.",
        },
        {
          question: "Do startups need an IP lawyer?",
          answer:
            "Yes, from day one. Protect your brand name with a trademark (₹15K-30K), your technology with patents if applicable (₹50K-2L), and your code/content with copyright (₹5K-15K). IP due diligence is mandatory for fundraising. Most investors require clean IP ownership. A startup IP audit costs ₹25K-50K and can prevent ₹10L+ problems later.",
        },
      ],
    },
    {
