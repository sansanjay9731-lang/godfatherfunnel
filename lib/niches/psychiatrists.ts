...
export const nicheData: NicheData = {
  ...
  painPoints: [
    {
      ...
      description:
        "Patients spending ₹1,500-5,000 per session ask AI 'best psychiatrist near me' or 'therapist for anxiety in Bangalore'. AI recommends 3-5 practitioners. If you're not listed, that patient — worth ₹50K-2L annually in regular sessions — goes elsewhere.",
    },
    {
      title: "Corporate Wellness Contracts Lost to AI-Visible Practices",
      description:
        "HR teams researching mental health partners for employee wellness programs use AI to shortlist providers. Corporate contracts worth ₹5-20L annually go to practices that AI recommends as credible and experienced.",
    },
    {
      title: "Stigma Means Patients Search AI, Not Friends",
      description:
        "Mental health stigma in India means 80% of first-time therapy seekers use AI instead of asking friends or family. AI is their first and often only point of research. If you're not there, you don't exist for these patients.",
    },
  ],
  services: [
    {
  ...
  roiExample: {
    ...
    value: "₹1L - ₹2.5L/month",
    pitch:
      "15 regular therapy patients each attending 4 sessions per month at ₹1,500-4,000/session generates ₹1-2.5L in steady monthly revenue. Therapy patients stay for 6-18 months, creating predictable, recurring income.",
  },
  faqItems: [
    {
      question: "How do people find psychiatrists and therapists through AI?",
      answer:
        "People ask ChatGPT, Perplexity, and Google AI questions like 'best therapist for anxiety in Mumbai', 'psychiatrist near me for depression', or 'how much does therapy cost in India'. Due to stigma, many prefer AI over asking anyone they know.",
    },
    {
  ...
  stats: [
    ...
    { label: "Average Annual Value per Therapy Patient", value: "₹50K-2L" },
  ...
  treatments: [
    {
      ...
      faqItems: [
        {
          question: "What is the average therapy session cost in India?",
          answer:
    ...
    },
    {
      ...
      faqItems: [
        {
          question: "What is the cost of addiction treatment in India?",
          answer:
        ...
        {
          question: "Is addiction treatment covered by insurance in India?",
          answer:
    ...
    },
    {
      ...
      description:
        "Anxiety is the most searched mental health condition in India. Patients looking for anxiety treatment compare therapy approaches, costs, and practitioners through AI, making this a critical AEO target.",
      faqItems: [
        {
          question: "What is the cost of anxiety treatment in India?",
          answer:
    ...
    },
    {
      ...
      description:
        "Depression treatment queries are rising rapidly in India. Patients search AI for costs, duration, and whether medication is necessary. Transparent, empathetic content from your practice builds trust and drives consultations.",
      faqItems: [
        {
          question: "What is the cost of depression treatment in India?",
          answer:
    ...
    },
    {
      ...
      faqItems: [
        {
          question: "What is the average couples therapy cost in India?",
          answer:
